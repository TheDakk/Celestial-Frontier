...
> `b091f010011fa16bec457599b41274b7f92bb5e6` and D-TRAIN-1 became the active bounded batch.

<!-- BEGIN VERBATIM ROADMAP HANDOFF: F2 CANONICAL INGRESS AND DISCRIMINATED NAVIGATION -->
...
manual deployment, or production-site write was performed or authorized.
<!-- END VERBATIM ROADMAP HANDOFF: F2 CANONICAL INGRESS AND DISCRIMINATED NAVIGATION -->

## ARCHIVED 2026-08-15 — F1b epoch-contract handoff superseded by merged integration and F2

> Moved byte-verbatim from `ROADMAP.md` after PR #29 merged, its exact `develop` battery and mapped
> development publication passed, and F2 canonical ingress became the active bounded batch.

<!-- BEGIN VERBATIM ROADMAP HANDOFF: F1B EPOCH PERSISTENCE CONTRACT -->
...
<!-- END VERBATIM ROADMAP HANDOFF: F1B EPOCH PERSISTENCE CONTRACT -->

## ARCHIVED 2026-08-15 — F1b audio/PR #28 handoff superseded by merged integration and epoch-contract work

> Moved verbatim from `ROADMAP.md` after PR #28 merged, its exact `develop` battery and mapped
> development publication passed, and the epoch persistence contract became the active bounded F1b batch.
...
<!-- END VERBATIM F1B AUDIO HANDOFF -->

## ARCHIVED 2026-08-15 — F1b WorldGen/PR #27 handoff superseded by merged integration and audio contract work

> Moved verbatim from `ROADMAP.md` after PR #27 merged, its exact `develop` battery and mapped
> development publication passed, and audio pre-initialization hardening became the active bounded F1b batch.
...
**Release status:** no release, manual deployment, production version bump, `develop` → `main`
merge, or direct site write is part of this batch.
<!-- END VERBATIM F1B WORLDGEN HANDOFF -->

## ARCHIVED 2026-08-15 — F1b UI-P1/PR #26 handoff superseded by merged integration and WorldGen contract work

> Moved verbatim from `ROADMAP.md` after PR #26 merged, its exact `develop` battery and mapped
> development publication passed, and WorldGen became the active bounded F1b batch.
...
## ARCHIVED 2026-08-15 — F1b Charter/PR #25 handoff superseded by merged integration and UI-P1 panel-chrome work

> Moved verbatim from `ROADMAP.md` after PR #25 merged, its exact `develop` battery and mapped
> development publication passed, and UI-P1 became the active bounded implementation batch.
...
## ARCHIVED 2026-08-14 — F1a review handoff superseded by merged integration and F1b Charter work

> Moved verbatim from `ROADMAP.md` after PR #24 merged and the bounded Charter hardening batch became
> the live implementation handoff.
...
## ARCHIVED 2026-08-14 — program-roadmap review handoff superseded by F1a implementation

> Moved verbatim from `ROADMAP.md` when Claude's roadmap/audio review was integrated and F1a
> became the active implementation batch.
...
## ARCHIVED 2026-08-14 — superseded full-sweep planning handoff

> Moved verbatim from `ROADMAP.md` when the comprehensive V2 program roadmap replaced the
> lean live handoff. The new live handoff points to `port/V2_PROGRAM_ROADMAP.md`.
...
## ARCHIVED 2026-08-13 — completed Arc 0 integration-open handoff
## Moved from ROADMAP.md verbatim after PR #18 merged, its required batteries succeeded, and the mapped DEV publisher completed.
...
## ARCHIVED 2026-08-13 — superseded master-architecture / implementation-not-started handoff
## Moved from ROADMAP.md verbatim during the Arc 0 Charter truth + canonical external planet-share Search ingress handoff.
...
## ARCHIVED 2026-08-13 — superseded PR #15 / A New Foundation handoff
## Moved from ROADMAP.md verbatim before the exploration/ships/loot/companions architecture handoff.
...
## ARCHIVED 2026-08-13 — superseded PR #13 development-publication handoff
## Moved from ROADMAP.md verbatim during the cumulative v2.0 bulletin refresh.
...
## ARCHIVED 2026-08-13 — superseded PR #11 branch-site handoff
## Moved from ROADMAP.md verbatim during the v2.0 development/presentation refresh.
