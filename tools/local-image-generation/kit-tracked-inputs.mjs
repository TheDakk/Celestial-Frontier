...
export const KIT_TRACKED_SOURCES=Object.freeze([
 ...
 'kit-stage-worker.mjs','creature-finish-math.mjs','kit-worker-engine.mjs','kit-worker-expansion.mjs','kit-engine-math.mjs','kit-contact-math.mjs','kit-weather-math.mjs',
].map(name=>'tools/local-image-generation/'+name));
export function assertTrackedKitSources(root,tracked){
 const files=new Set(tracked??execFileSync('git',['ls-files','-z'],{cwd:root,encoding:'utf8',maxBuffer:16*1024*1024}).split('\0'));
