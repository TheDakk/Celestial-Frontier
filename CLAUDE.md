...
## Project layout
- `celestial-frontier.html` — the entire game (~7,580 lines; one `<style>`, markup, one `<script>` from ~line 948). No build step, no runtime dependencies. Run by opening in a browser.
