...
| `[EXEC-TODO]` | No leaks across repeated travel, Compendium and future Shipyard cycles | Arc 1A implements maximum-Compendium virtualization and lease/cache/worker ownership. Exact `aecf386…` bounds static-server close and suppresses PASS/sample on cleanup red. Clean `6736ef4…` c27/baseline11/c28/c29 evidence activates budget/test `546d3a81…` / `ef06252a…` at `b3957e1…`; candidates are 78/78 with complete lifecycle, baseline11 retains four faults and 14 phone / 13 desktop breaches, and prior ceilings remain strict. Run `32420327368` remains no-verdict history. Actions remain FROZEN. This row still awaits exact-head certification plus Arc 1B's scene Canvas/Pixi and combined travel → Compendium → Shipyard plateau. |
...
| | Criterion | Evidence |
|---|---|---|
| `[EXEC-TODO]` | Maximum-size Compendium mounts/paints only a bounded visible window and plateaus after warmup | Product virtualization, art ownership, focus/filter/detail/Close outcomes, and the owner→worker→painter graph are implemented. Candidate24/25/26+baseline10 are historical. Clean fresh-.86 `6736ef4…` c27/baseline11/c28/c29 evidence activates budget/test `546d3a81…` / `ef06252a…` at `b3957e1…`, with 78/78 candidates, complete lifecycle, baseline discrimination, and strict ceilings. Exact-head battery and PR CI remain open; Arc-local Edge 151 still does not repin Gate A. |
...
| `[EXEC-TODO]` | Performance and heat budgets | `budgets.json` sets bundle + answerability. Arc 1A's old rulers through candidate26/baseline10 remain history. Clean `6736ef4…` c27/baseline11/c28/c29 evidence activates repaired budget/test `546d3a81…` / `ef06252a…` at `b3957e1…`; previous ceilings remain strict. Exact `731b2e2…` and hosted no-verdict run `32420327368` remain history. Exact-head certification, Arc 1B scene/Pixi/GPU plateaus, and physical-device heat/battery evidence remain open. |
