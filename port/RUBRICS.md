...
`39e4f20fb35e47d5a05855f040ad1ae1cd921f75` began Final5. Layout passed 787/787 and
source-bound SceneMemory passed 42/42. Compendium then ran once, stopped `instrument-fail` after
3,237 ms with 0/78 retained product outcomes, and was not retried; Slice, Glass and recovery did
not start. The failed cold-key oracle compared eight mounted fixture keys with eight pre-arm cached
keys even though the errored row's exact visual key was absent from the cache. This is an instrument
cardinality defect, not a Compendium product verdict.

The bounded repair proves exact set membership and negative-controls a cached/wrong key. Current
collector `c13a489d…3faab`, outcome contract `ac7eea39…6d17`, measurement `28b06f3c…276c` and
budget-file `3e660742…2ae5` replace the signed Final5 evidence authorities; producer
`bf9ad0b6…4dcb`, historical samples and every numeric ceiling remain unchanged. A newly signed
clean Final6 checkpoint must restart the complete chain at Layout; Final5 cannot resume. No current
Compendium product PASS, Slice, Glass, recovery, publication, hosted attempt, release, deployment,
version bump or external authority exists. Compatible Edge/Chrome point updates, including `.107`
at CDP `1.3`, are provenance only and never trigger a rebaseline or threshold change.
...
| | Criterion | Evidence |
|---|---|---|
| `[EXEC]` | Maximum-size Compendium mounts/paints only a bounded visible window and plateaus after warmup for the current producer | **`[HISTORICAL]` for the repaired worktree.** Product virtualization, art ownership and focus/filter/detail/Close outcomes are implemented. Measurement `cb5cd9f8…15d`, former producer `587d3bdf…e4d73`, selected candidate3/5/6, baseline1, activation `d33e540…`, and certificate `20260826-phase4-certification` remain truthful historical proof. Signed calibration `8ffd2e2…`, historical budget `6284a394…`, former producer `f7c87f22…`, activation `91f4e044…` and its 78/78 certificate likewise remain historical. Signed `041d1cf…` supplied the latest green Final4 Compendium 78/78 certificate. Signed `39e4f20…` reached Final5 Compendium after Layout 787/787 and SceneMemory 42/42, but the one run stopped instrument-only at 0/78 because equal-size key sets were mistaken for identical membership; it made no product judgment and was not retried. Current collector `c13a489d…3faab`, outcome contract `ac7eea39…6d17`, measurement `28b06f3c…276c`, budget-file `3e660742…2ae5` and unchanged producer `bf9ad0b6…4dcb` require a newly signed fresh Final6 chain. Browser authority remains Edge family + CDP `1.3` + sealed capability-contract SHA-256 `6eed33ed9784f7c7774c4b1bf8d4e880986e31667324d9a1aa7b8dd62fe5a476`; `.107` is provenance only. Six-image HUMAN judgment, current Compendium product PASS, Slice, Glass, recovery and whole-Gate closure remain outstanding. |
...
| `[EXEC]` | Tame/Scavenge/Sample are the finite acquisition writers for catalogue pages, specimens and owned fauna | **`[RED]` until the bound final campaign passes.** Native Survey controls bind exact nav/address, the production full roster/current epoch and all-scenario capacity before two F4 draws; they spend on hit or miss and commit first-only reward, repeat individual/lot, one receipt/CAS, exact committed verification and targeted publication. Source-bound random-pool odds/budget, presentation fencing, native Close/reopen and historical exact-input outcomes remain. One exact durable fauna Tame result may join an accessible asset-free greeting. The first eight Slice reds remain historical diagnosis. Signed `041d1cf…` supplied the historical Final4 Slice PASS after green predecessors; Glass then stopped. Signed `39e4f20…` supplied Final5 Layout/SceneMemory greens before Compendium stopped instrument-only at 0/78, so no new Slice or recovery evidence exists. The exact-membership repair must complete fresh signed Final6 from Layout. Post-start audio and real recovery remain unproved. Separate HUMAN journey/listening review, Charter bioscan, targeted preview, hosted and release authority remain open. |
...
| `[EXEC-TODO]` | Accessibility audit | Final4 Glass reached the real 12-viewport audit and correctly retained Exotic `#9A5CFF` at 2.86:1 over effective bright glass as a product red, separately from stale title/scroll/settlement/Shipyard instrument assumptions. Signed `39e4f20…` contains the repair preserving that hue on opaque `#05070d`, restoring exclusive sticky-Close geometry and adding live contrast/hit/scroll controls, but Final5 stopped at Compendium before Slice or Glass. A fresh signed Final6 Glass result and physical assistive-technology review remain required. |
| `[EXEC-TODO]` | Performance and heat budgets | Historical Arc 1A/1B/1C certificates and the signed heap-only activation remain bound to their exact producers. Signed `041d1cf…` supplied historical Final4 SceneMemory 42/42 and Compendium 78/78 after Layout, then Slice PASS before Glass stopped. Signed `39e4f20…` supplied Final5 Layout 787/787 and source-bound SceneMemory 42/42 before Compendium stopped instrument-only at 0/78. Current SceneMemory budget is `a23a3d80…8355`; repaired Compendium collector/outcome-contract/measurement are `c13a489d…3faab` / `ac7eea39…6d17` / `28b06f3c…276c`, budget-file SHA is `3e660742…2ae5`, and producer remains `bf9ad0b6…4dcb`. Numeric ceilings, rulers and samples are unchanged; fresh Final6 from Layout is required. Both authorities are compatible Edge family + CDP `1.3`; `.107` and later compatible point updates are provenance only. True GPU bytes and physical-device heat/battery remain open, so this row and Gate I stay open. |
