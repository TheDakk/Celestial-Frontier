...
| `[EXEC-TODO]` | Performance and heat budgets | `budgets.json` sets bundle + answerability. Arc 1A's older rulers and exact-f9/c49/139/964/89, candidate20, and candidate21/22/23+baseline9 carriers remain preserved history. Clean exact `fb321f2…` candidate24/25/26 plus paired baseline10 activated budget `70145575…`. Exact `731b2e2…` passed locally; hosted run `32420327368` was consumed at its 40-minute lifecycle-pending ceiling with no product verdict, so PR #32 remains blocked and is not rerun authority. Arc 1B scene/Pixi/GPU plateaus and physical-device heat/battery evidence remain open. |
