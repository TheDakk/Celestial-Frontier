...
const EVIDENCE = Object.freeze({
  file: 'ARC1C_COMPENDIUM_PR35_PAINTER_IMPORT_PRODUCT_FAILURE_20260830_38D8848.json.gz',
  gzipBytes: 6_053,
  gzipSha256: 'e45b2f65cc93ad717524d52ebddfdd504e2abedf5296d6d5aa287e949be968aa',
  rawBytes: 37_825,
  rawSha256: '63014b6dfea3790fe3618344bdf8d5b31de68e1ac54798f5fe80b5a41092ccf5',
  runId: '20260830-pr35-recovered-oracle-38d8848c9840-compendium-certification',
  sourceCommit: '38d8848c984089d33f4bafa1043e36c2cbb2ce9e',
  ...
  budgetSha256: '6ba77f1084d07610ca867cafb76dcae602d9d62f8acf3a6893d9e13db37b40a5',
...
describe('exact-source PR #35 Compendium painter-import product stop', () => {
  ...
  it('binds the exact signed source, once-only lifecycle, and clean browser authorities', () => {
    expect(report).toMatchObject({
      ...
      status: 'product-fail',
      startedAt: '2026-08-30T09:52:16.476Z',
      endedAt: '2026-08-30T09:52:19.591Z',
      durationMs: 3_115,
