...
const EXPECTED_DOMAIN_FILES = Object.freeze([
  ...
  'acquisition/src/guardian-companion.ts',
  ...
  'combatcore/src/friendly-duel.ts',
  ...
  'worldidentity/src/authority.ts',
  'worldidentity/src/index.ts',
  'worldidentity/src/mint-internal.ts',
