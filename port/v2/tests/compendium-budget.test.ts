...
const EXPECTED_PRODUCER_AUTHORITY =
  'bf9ad0b6623913bfff5b5e79a8ed9ac7dbe49424b608bc9fee8621e5c4874dcb';
const EXPECTED_PRODUCER_AUTHORITY_RECORD = Object.freeze({
  ...
  inputs: Object.freeze({
    index: Object.freeze({
      relativePath: 'index.html',
      sha256: '956c5ef0ea1b1a558126b3ffda5ff3c6b26ac6ca66751ad9e3ea7b9bea2f8f59',
    }),
    owner: Object.freeze({
      relativePath: 'assets/main-Cn5PQght.js',
      sha256: '762bc168f3f912d63654851067fc31a3f2ab9f6e0a387048178fea5d44db508d',
    }),
    worker: Object.freeze({
      relativePath: 'assets/species-art.worker-MsuHQ8El.js',
      sha256: '85f4fdf2e8214814466735d3b4f2abbe3b7c7bb601ebe40034dd9ab06d2d7c28',
...
describe('Arc 1A Compendium budget authority', () => {
  ...
  it('activates the current producer without rebinding the historical ruler', () => {
  ...
  it('rederives every active sample from the four retained slice-repair carriers', () => {
    expect(activeBudget.status).toBe('active');
