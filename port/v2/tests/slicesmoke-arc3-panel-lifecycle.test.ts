...
const GLOBAL_BINDINGS = [
  ...
  ['hittable rail button', "surface?.shipyard?.buttonId === 'railshipyard'", 1],
  ['native rail button', "surface?.shipyard?.buttonTag === 'BUTTON'", 1],
  ['current right-rail owner', "rightRailReady: surface?.rightRail?.id === 'railrgt'", 1],
