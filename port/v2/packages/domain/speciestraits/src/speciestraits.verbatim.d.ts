...
export function colorGrade(kindHue: number | string, seed: number, opts?: { salt?: number; boost?: number; force?: number; suffix?: string } | null): Grade;
...
export const SP_COLOR: readonly string[]; export const SP_HEX: Readonly<Record<string, string>>;
...
export const FA_PATTERN: readonly string[]; export const FA_EYES: readonly number[];
