...
describe('@cf/audio — bounded sting facade', () => {
  it('reproduces the raw pre-init defect while all five non-initializer public operations stay inert', async () => {
    ...
    expect(Object.keys(api).sort()).toEqual([
      ...
      'AUDIO_ASSET_ROLES', 'AUDIO_CATEGORIES', 'AUDIO_KINGDOM_ORDER', 'AUDIO_LEGACY_FALLBACK', 'AUDIO_LIMITER_SETTINGS',
      'AUDIO_NEUTRAL_VOICE_MIX_INTENT_V1',
      'AUDIO_PALETTE_POLICY', 'AUDIO_REDUCED_INTENSITY_GAIN', 'AUDIO_RESOLVER_VERSION', 'AUDIO_RESOURCE_MEASUREMENT_DIAGNOSTICS',
      ...
      'COMBAT_CUE_PARTICIPANTS_SCHEMA_V1', 'COMBAT_CUE_PLAN_SCHEMA_V1',
      'applySfxGain',
      ...
      'captureAudioLabSample', 'combatCuePlan',
      'createAudioIdentityProfile', 'createAudioRuntime', 'createAudioSignature',
      'createAudioSoundOutputWitness', 'createAudioVoiceMixIntentV1',
      'createCombatGameplayVoiceRequest', 'createCreatureCallPlan',
      ...
      'isAudioKingdom', 'isCombatCueParticipantsV1', 'isCombatCuePlanV1', 'playRaritySting',
      'playSurveyPing', 'playWhoosh', 'prepareStingAudioForGesture',
      'projectCombatCueParticipantsV1', 'serializeAudioSignature', 'serializeAudioSoundOutputWitness',
    ]);
    const before = {
