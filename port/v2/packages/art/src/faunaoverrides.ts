...
export const FAUNA_NAME: Record<string, FaunaPainter> = {
  ...
  'Crane': (c, g, p, n) => faunaBird(c, g, p, { hue: '#a3a39b', legs: 0.13, bill: 'long', crest: true }, n),
  'Stork': (c, g, p, n) => faunaBird(c, g, p, { hue: '#e6e2d8', legs: 0.12, bill: 'long' }, n),
  'Spoonbill': (c, g, p, n) => faunaBird(c, g, p, { hue: '#e2607f', legs: 0.11, bill: 'spoon' }, n),
  'Avocet': (c, g, p, n) => faunaBird(c, g, p, { hue: '#cfd2d4', legs: 0.11, bill: 'long' }, n),
  'Ibis': (c, g, p, n) => faunaBird(c, g, p, { hue: '#b8352f', legs: 0.10, bill: 'long' }, n),
