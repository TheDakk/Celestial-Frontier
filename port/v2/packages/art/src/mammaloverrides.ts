...
export const QUAD2_SPEC: Record<string, QuadSpec> = {
  ...
  'Cattle': { legs: 0.1489, depth: 0.1717, len: 0.2112, neck: 0.07, muzzle: 0.46, jaw: 'broad', ears: 'large', tail: 'tuft', horn: 'shorthorn', coat: 'blotches', family: 'bovid', earShape: 'spoon' },
  ...
  'Wild Ass': { legs: 0.1901, depth: 0.142, len: 0.1863, neck: 0.12, muzzle: 0.50, ears: 'huge', tail: 'tuft', hue: '#b8ab93', family: 'equid', earShape: 'leaf' },
  'Donkey': { legs: 0.1781, depth: 0.1454, len: 0.1788, neck: 0.11, muzzle: 0.50, ears: 'huge', tail: 'tuft', hue: '#9b948c', family: 'equid', earShape: 'leaf' },
