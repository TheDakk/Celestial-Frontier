...
export function expandCompactMyriapod(template,counts){
 ...
 return {...template,anatomyModel:'myriapod-rigid-trunk-v1',graph,joints:['root',...graph.map(([j])=>j)],legs,limitsDeg:limits,bodyAxis,
  ...
  contactStance:{default:'all',actions:{},swingLift:'toward-socket',travelSubsteps:{hit:2,dodge:2,tame:2},gaits:{'approach:crawl':'alternating'},travel:{'melee:mandible':'source-steps','melee:body':'source-steps',hit:'source-steps',dodge:'source-steps',tame:'source-steps'}}};
}
