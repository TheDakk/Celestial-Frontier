...
if(!['parts','--portrait-fallback','--repair-gates','--repaired-parts','--band-gates','--pair-gates','--seam-gates','--seam-parts','--skin-gates','--hinge-gates','--hinge-parts','--skin-parts'].includes(mode))throw Error('Unknown proof mode');
