...
export const ENGINEERING_GLASS_RECIPE_ORACLE = Object.freeze([
  ...
  recipeFixtureRow('fieldsuit', 'unavailable', 'live', 'false', true),
  recipeFixtureRow('hazmat', 'unavailable', 'live', 'false', true),
  ...
  recipeFixtureRow('compass', 'unavailable', 'live', 'false', true),
  ...
  recipeFixtureRow('cg-chron', 'unavailable', 'live', 'false', true),
