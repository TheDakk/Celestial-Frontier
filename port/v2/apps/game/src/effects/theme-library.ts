...
export const THEME_EMITTERS: Readonly<Record<EffectTheme, Phases>> = Object.freeze({
  fire: ph({ launch: { gravity: -0.4, speed: [0.1, 0.35], drag: 2, lifeMs: [220, 380] }, travel: { rate: 360, gravity: -0.3, lifeMs: [150, 260] }, impact: { gravity: -0.25, drag: 1.6, speed: [0.25, 0.9], lifeMs: [260, 520] } }),
  frost: ph({ launch: { burst: 30, gravity: 0.9, speed: [0.1, 0.3], size: [2, 6] }, travel: { rate: 240, gravity: 0.4 }, impact: { gravity: 2.2, drag: 0.8, speed: [0.3, 1.0], size: [2, 8] } }),
  storm: ph({ launch: { speed: [0.4, 0.9], spreadRad: 1.2, gravity: 0, drag: 4, lifeMs: [80, 160] }, travel: { rate: 420, speed: [0.1, 0.3], lifeMs: [60, 120], gravity: 0 }, impact: { speed: [0.6, 1.4], gravity: 0.5, drag: 2, lifeMs: [120, 260] } }),
  tide: ph({ launch: { gravity: 1.2, speed: [0.2, 0.5] }, travel: { rate: 320, gravity: 0.8 }, impact: { directionRad: UP, spreadRad: 1.2, speed: [0.3, 0.9], gravity: 2.6, lifeMs: [240, 480], alphaCurve: 'ease-out', size: [2, 6] } }),
  stone: ph({ launch: { burst: 28, speed: [0.1, 0.3], gravity: 1.8, size: [2, 6] }, travel: { rate: 200, gravity: 1.2, size: [2, 5] }, impact: { speed: [0.2, 0.7], gravity: 2.4, drag: 1, lifeMs: [300, 600], size: [3, 9] } }),
  venom: ph({ launch: { burst: 24, gravity: 1.0, size: [2, 4] }, travel: { rate: 260, gravity: 0.9, lifeMs: [160, 280] }, impact: { maxParticles: 90, burst: 90, spreadRad: 1.1, gravity: 2.0, lifeMs: [260, 520], alphaCurve: 'ease-out', size: [2, 6] } }),
  void: ph({ launch: { directionRad: Math.PI, speed: [0.2, 0.5], drag: 5, gravity: 0, lifeMs: [200, 360] }, travel: { rate: 200, speed: [0.02, 0.06], gravity: -0.1 }, impact: { directionRad: 0, spreadRad: Math.PI, speed: [0.5, 0.9], gravity: 0, drag: 6, lifeMs: [200, 400], size: [2, 5] } }),
  sand: ph({ launch: { speed: [0.2, 0.5], spreadRad: 0.4, gravity: 0.9, size: [1.5, 3.5] }, travel: { rate: 400, lifeMs: [100, 180], spreadRad: 0.3, size: [1, 3] }, impact: { directionRad: 0, spreadRad: 0.9, speed: [0.3, 0.9], gravity: 1.2, drag: 1.5, lifeMs: [220, 420], alphaCurve: 'linear', size: [1.5, 4] } }),
  chem: ph({ launch: { burst: 32, gravity: -0.6, speed: [0.05, 0.2], size: [1.5, 4], lifeMs: [200, 400] }, travel: { rate: 300, gravity: -0.4 }, impact: { gravity: -0.5, spreadRad: 1.4, speed: [0.15, 0.5], lifeMs: [300, 600], alphaCurve: 'ease-out', size: [2, 6] } }),
  psionic: ph({ launch: { burst: 24, speed: [0.05, 0.15], drag: 4, gravity: 0, spreadRad: Math.PI, size: [3, 8], lifeMs: [260, 420] }, travel: { rate: 120, speed: [0.01, 0.04], gravity: 0, size: [4, 10] }, impact: { maxParticles: 60, burst: 60, directionRad: 0, spreadRad: Math.PI, speed: [0.3, 0.5], drag: 3, gravity: 0, lifeMs: [200, 340], size: [4, 12] } }),
  wild: ph({}),
});
