...
export type WeeklyCharterEventKindV1 = 'landfall' | 'mined' | 'bioscan' | 'crafted';
export type WeeklyCharterIdV1 = 'wk-land' | 'wk-mine' | 'wk-scan' | 'wk-craft';
...
/** The live weekly pool: every definition here has an event owner in v2 today. (Conquest, species, feeding and breeding join when
 *  their owners report weekly progress; the conquest settlement is Arc 6's.) */
