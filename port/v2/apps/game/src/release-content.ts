  ...
  sections: Object.freeze([
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        '🔊 THE FRONTIER SPEAKS: Survey pings and travel, planetfall, and ascent whooshes answer the live exploration loop. The persistent master Sound control immediately silences any sting already ringing, while Volume stays remembered for the next enabled sound. Creature voices now adds one deterministic synthesized greeting after a verified durable wild-fauna Tame succeeds and its visible status alert settles; misses, refusals, repeats, reloads, hidden play, and disabled Sound or Creature voices remain silent without retry or replay. Other creature actions, ambience, music, and combat sound remain future work.',
      ]),
    }),
    Object.freeze({
