  ...
  sections: Object.freeze([
    ...
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        '🎓 FIELD TRAINING LIVES IN THE NEW SHELL: Six real lessons teach finding Earth, surveying, charting, opening the Atlas, and landing, followed by an honest Finish for now. Restart and Skip preserve the pre-training view instead of pretending the full legacy curriculum is ported.',
      ]),
    }),
    Object.freeze({
      category: 'Bug Fixes',
