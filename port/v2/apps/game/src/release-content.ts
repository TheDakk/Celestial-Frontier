  ...
  sections: Object.freeze([
    ...
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        '🫧 ONE GLASS LANGUAGE: Rounded name, health, objective and navigation controls carry the production layout forward. Your objective sits at the upper-right below Search, followed by Star Atlas and Shipyard on larger screens. A red heart accompanies Health and its exact count; bottom guidance is plain text, and the Current view readout is hidden.',
