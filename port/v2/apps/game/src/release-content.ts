  ...
  sections: Object.freeze([
    ...
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        '🪐 SHEETS KEEP THEIR ROOM: Panels share a title strip and sticky Close, scroll inside their own bounds, and clear measured guidance, captions and notices even with larger text. Survey keeps its title and Close visible while details scroll above the biosphere. On crowded phones, notices use compact headlines; Notifications keeps the full messages. Settings stays available above Field Training; closing it returns you to the lesson without changing your progress.',
