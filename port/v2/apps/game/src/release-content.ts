  ...
  sections: Object.freeze([
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        '🖌️ PAINTED EARTH LANDFALLS: Land shows the accepted painter composition immediately. With the local model ready, a finished painting fades in while you keep playing. View never travels or starts another painting; Inspect opens the retained original at its actual size.',
        'The local painting engine keeps its models warm between landings. Browser model downloads are explicit and resumable; a damaged install offers Restart. Originals are kept separately from model files. Earth is the first supported art library; phone performance still awaits a device probe.',
