  ...
  sections: Object.freeze([
    ...
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        '🫧 ONE GLASS LANGUAGE: The v2 command deck unifies the top bar, objective, breadcrumbs, Survey, panels, contextual hints, bottom launcher on every device in one responsive presentation. Your current view stays in the top header, aligned context actions stack at the upper-left, and a framed health gauge keeps the exact HP count readable.',
