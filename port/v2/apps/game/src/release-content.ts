  ...
  sections: Object.freeze([
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        '🖌️ LOCAL AI PREVIEW: The developer-only localai query now queues supported Earth paintings after the ordinary Land action. Survey and Notifications show drawing progress, cancel and View landfall; exact originals are retained separately for reload. Browser model downloads are explicit and resumable. This experimental path needs the local preview runtime; artwork acceptance and phone qualification remain pending.',
        'The optional local AI preview adds full-painting inspection with Fit painting and actual-size detail, including retained originals after reload. The optional offline package includes six individual Earth species references; Local model storage stays open during progress so Pause remains reachable. Worker imports stay bound to the same retained app build. Physical-phone delivery and generated species accuracy remain under review.',
        'The optional local AI preview can prepare a faster drawing copy from its verified browser model, using about 336 MiB of extra storage. It requires an explicit Prepare or Verify action, keeps existing paintings available across drawing choices, and preserves image size and all six species references. Art acceptance and physical-phone performance remain under review.',
