  ...
  sections: Object.freeze([
    ...
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        '⚖ COMPARISON TELLS THE WHOLE STORY: Inventory opens from the phone dock or desktop rail, keeps a bounded 48-row page, and gives one selected item a focus-owned detail sheet whose comparison includes every base and affix delta, conditional context, provenance, and equipped state. While the detail is open, current and newly mounted background surfaces stay inert and hidden from assistive technology; Close restores each surface\u2019s exact prior state. On the narrowest phones, full item copy now reflows above its wrapping badges instead of being starved beside them.',
