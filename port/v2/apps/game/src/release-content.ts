  ...
  sections: Object.freeze([
    ...
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        '📦 ART ARRIVES WHEN IT IS NEEDED: The large species-art payload loads lazily for Compendium or Planetside, shares one in-flight request, and retains only the latest subscriber per surface instead of pinning an entire catalogue of callbacks.',
