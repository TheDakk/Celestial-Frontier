...
export const V2_DRAFT_RELEASE = Object.freeze({
  ...
  sections: Object.freeze([
    ...
    Object.freeze({
      category: 'Gameplay',
      bullets: Object.freeze([
        '🚀 SURVEY BEFORE YOU TRAVEL: One selection opens a card; explicit Enter galaxy, Enter system, Land, and Leave world actions make descent deliberate on mouse, touch, and keyboard instead of depending on a second tap or timing window. First-time Land shows the exact type/biome/weather/gear-adjusted success chance and bounded nonlethal wave-off damage. A wave-off stays in orbit and teaches +20% exact-world approach knowledge, up to five times; Earth, Training, and known-world returns are guaranteed with zero landing draws.',
