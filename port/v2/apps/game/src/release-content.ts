  ...
  sections: Object.freeze([
    Object.freeze({
      ...
      bullets: Object.freeze([
        'A playable TypeScript and Pixi development slice now spans deterministic universe, galaxy, system, and Planetside navigation.',
        'The current Star Atlas, Compendium, Records, Charters, Settings, Field Training, and protected expedition import surfaces are available for development playtests.',
      ]),
    }),
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        'On landed touch layouts, the objective yields to populated Planetside until ascent. Portrait keeps the trail visible; short landscape also yields the trail and starts Planetside below the measured top chrome. Dock icons stay centred inside their 44-pixel actions without hidden scrolling, and A++ keeps toast titles visibly larger than their message text.',
    ...
    Object.freeze({
      category: 'Gameplay',
      bullets: Object.freeze([
        'CF1 world addresses preserve full destination identity and accepted custom planet names; an in-reach address returns to survey instead of bypassing Land, while an out-of-reach address leaves the explorer in place and names the milestone.',
        'Charter reach is enforced at travel time, and only a first planetfall earns new landfall progress.',
      ]),
    }),
    Object.freeze({
      category: 'Bug Fixes',
      bullets: Object.freeze([
        'Sparse, corrupt, transiently unavailable, and newer-build saves are classified before promotion so protected bytes cannot be silently replaced.',
        'Expedition import now cancels and drains queued preference saves before replacement, preventing an older settings write from overwriting the imported expedition.',
        'When browser storage permits the optional import keepsake, it now retains the exact submitted text—including legal surrounding JSON whitespace—while the moderator-held source file remains the byte-for-byte authority.',
        'Survey actions bind to full composite identity, preventing a same-seed object at different coordinates from inheriting stale Land, Atlas, or Share controls.',
        'Reduced motion now freezes nonessential scene transforms instead of merely hiding a subset of effects, and display-density changes rebuild a capped sharp backing store without losing navigation or the open survey.',
        'Share feedback no longer claims success after clipboard denial; the exact code is selected in Search as an honest fallback.',
    ...
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        'Responsive glass and persona playtest tools record machine-readable outcomes and retain a red run without automatic retries or cascade-hiding.',
      ]),
    }),
  ]),
