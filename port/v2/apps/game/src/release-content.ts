  ...
  sections: Object.freeze([
    ...
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        '🧭 THE ATLAS LEADS BACK: Charted galaxies, stars, and worlds can reopen their own navigation level only after the saved route is regenerated from the seeded universe and source-verified. Stale, forged, or incomplete rows remain visible but disabled with an honest unavailable label; a proven planet entry returns to Survey and Land remains explicit. Accepted Atlas, Search, and CF1 arrivals may paint the same deterministic, skippable hyperlane streak overlay after the route publishes. Fusion, Antimatter, and Warp Fold use 2×, 4×, and 8× speed bases. Effects, Motion, and device limits may reduce or omit the treatment without delaying or changing the destination.',
