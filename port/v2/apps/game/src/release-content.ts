  ...
  sections: Object.freeze([
    ...
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        '🪐 SHEETS KEEP THEIR ROOM: Panels share a title strip and sticky Close, scroll inside their own bounds, and clear measured guidance, captions and notices even with larger text. Survey keeps a clear stack above the scrollable biosphere. Settings stays available above Field Training; closing it returns you to the lesson without changing your progress.',
