...
export const V2_DRAFT_RELEASE = Object.freeze({
  ...
  sections: Object.freeze([
    ...
    Object.freeze({
      ...
      bullets: Object.freeze([
        '📱 THE COMMAND DECK FINDS ITS RHYTHM: A measured shelf, five labelled phone boards, evenly spaced utility controls and gold selection restore the compact exploration layout. Inventory opens from your nameplate; desktop and tablet utilities sit together at the bottom right. Local Inter respects your font and larger-text preferences.',
