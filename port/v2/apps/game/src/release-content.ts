  ...
  sections: Object.freeze([
    ...
    Object.freeze({
      ...
      bullets: Object.freeze([
        ...
        '🪐 SHEETS KEEP THEIR ROOM: Panels share a title strip and sticky Close, scroll inside their own bounds, and clear measured guidance, captions and notices even with larger text. Survey keeps its title and Close visible while details scroll above the biosphere. On crowded phones, notices use compact headlines; Notifications keeps the full messages. Scene instructions tuck away only when a landed Survey and biosphere need their space, then return when room is available. Settings stays available above Field Training; closing it returns you to the lesson without changing your progress.',
        ...
        '✕ ONE SURFACE, ONE CLOSE: Every panel and Survey card owns exactly one 44-pixel top-right Close action with a reserved content gutter, so refilling or scrolling a surface cannot duplicate it, detach it to the upper-left, place another control beneath it, or strand keyboard focus behind a hidden surface. Spacing inside the side navigation belongs to its controls and leaves the active panel open; a genuine empty-sky press still dismisses it.',
