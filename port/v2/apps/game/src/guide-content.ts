...
export const GUIDE_TOPIC_SUPPORT: Readonly<Record<GuideTopicId, GuideTopicSupport>> =
  Object.freeze({
    ...
    determinism: partial(
      ['deterministic-world'],
      '<p>The universe is generated from seeds on your device. The same supported coordinates resolve to the same galaxy, star, world, and current-slice survey, which is why deterministic <b>CF1</b> addresses work without an account or game server.</p><p>The universe itself does not need to be stored; your expedition record does. Shared timed events and creature duels from the mature game are not yet available in this v2 development slice.</p>',
    ...
    settings: partial(
      ['settings'],
      '<p><b>Settings</b> currently controls sound, volume, Star charts, panel tint, text size, text tone, font, motion, Field Training restart, and protected expedition import. Preferences persist with the expedition.</p><p>Restart begins the current six-lesson drill in Sol and restores the pre-training view when the drill finishes or is skipped. If persistence fails, restart is cancelled. See <span data-gt="saving">Your save & reset</span>.</p>',
    ...
    saving: partial(
      ['protected-saves'],
      '<p>The expedition saves to IndexedDB in this browser. Open <b>Settings → Bring expedition</b> to import a complete supported save. A proven backup may recover a damaged primary.</p><p>A newer-build, incomplete, or corrupt stored expedition is held unchanged and announced as <b>Update required</b> or <b>Save protected</b>. Ordinary play cannot silently overwrite protected bytes. There is no cloud account yet.</p>',
