...
export const GUIDE_TOPIC_SUPPORT: Readonly<Record<GuideTopicId, GuideTopicSupport>> =
  Object.freeze({
    ...
    survey: partial(
      ['survey-cards'],
      '<p>Tap a galaxy, star, or planet once to open its current <b>survey card</b>. A galaxy or star card offers an explicit Enter action. A planet card offers <b>Land</b>, <b>Star Atlas</b>, and <b>Share</b> when those actions are valid.</p><p>The card is bound to the selected object’s full identity, including coordinates, so a same-seed object elsewhere cannot inherit stale actions. This selection is navigation and inspection: it does not spend a resource, discover life, capture a species, or authorize extraction.</p><p>After landing on a proven lifeless non-Earth world, <b>Engineering &amp; Shipyard</b> presents the separate grounded mineral reveal and its finite Mine action. That reveal describes the current opportunity but is not itself a mining receipt. Deep Scanners has a canonical orbital-reveal policy, but the current Survey card does not yet paint those orbital mineral rows. See <span data-gt="landing">Landing</span>, <span data-gt="mining">Mining &amp; the Cargo hold</span>, and <span data-gt="atlas">The Star Atlas</span>.</p>',
      'The current survey card covers navigation, charting, sharing, and planetfall; grounded mineral facts and durable extraction live separately in Engineering, while life discovery and capture remain unavailable.',
    ...
    discover: unavailable(
      ['life-discovery'],
      'Survey selection and Engineering mineral reveal do not catalogue life. Interactive biosphere discovery, taming, scavenging, sampling, and Field Scout outcomes are not yet ported.',
    ),
    kingdoms: partial(
      ['compendium-read'],
    ...
    stardust: partial(
      ['stardust'],
      '<p>The expedition preserves its imported/current <b>Stardust</b>. Engineering shows the exact amount owned beside each cost, and a successful Deep Scanners purchase or eligible fixed Fabricator recipe spends its stated Stardust in the same durable transaction as the result.</p><p>No current v2 action earns Stardust. Rare-life discovery rewards, Charter rewards, passive gain, and the rest of the mature earning/spending economy remain unavailable.</p>',
      'Engineering can spend preserved Stardust through exact live costs; no Stardust earning faucet is connected yet.',
