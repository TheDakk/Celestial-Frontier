...
const presence=(pairs=14):Extract<AnatomyPresence,{schema:'cf.anatomy-presence/v2'}>=>({schema:'cf.anatomy-presence/v2',absent:[],hidden:[],folded:[],appendages:{walkingLegPairs:pairs,ultimateLegPairs:1}});
function fixture(){
