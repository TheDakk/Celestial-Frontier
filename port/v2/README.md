...
> **2026-09-03 UTC current native-Tab identity / terminal-diagnostic overlay (matches current local
...
scroll. Transport/document/carrier failures are instrument-red; wrong Tab origin, missing current
controls, stale lineage, lost restoration, unsettled scroll or transparent focus decoration are
product-red. Dedicated mutations prove both directions.
