...
> the three-run maxima. This activation is browser-free and non-certifying; run one
> exact-activation-head local battery and one corresponding PR test-merge CI attempt. First red
> stops; then work returns to Arc 1B/gameplay
> after PR #32 closes.
...
candidate17/18/19. The activation is browser-free and non-certifying; run one exact-activation-head
battery and one corresponding PR test-merge attempt. Do not expand timing policy or optimize the
accepted CI allowances; first red
...
not certification. One exact-activation-head battery and one corresponding CI attempt close this
cycle before Arc 1B/gameplay resumes; first red stops and this is not broader timing work.
