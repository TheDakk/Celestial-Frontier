...
create `releasePending`, or create a production release. There is no player save-import door.
...
| **Current living-world inspection boundary (2026-09-05)** | Recovered core living-world card inspection preserves raw save, RNG, revision and the prior Survey outcome without a receipt. Star/nonliving-world Survey retains its existing receipt-bearing contract. `slicesmoke` proves the appropriate exact commit/current/inspection fixed point, including persistence, route/render/card/action identity and coordinator idle, before dependent pointer, keyboard or touch Enter/Land. This integration adaptation has its own current-source gates recorded in `../../audits/BATCH4_OVERNIGHT_REPORT_20260905.md` and red history in `../../audits/BATCH4_OVERNIGHT_REDS_20260905.json`; no acceptance is inferred here. The dated row below retains only its original 2026-09-01 / `4a595e2` evidence and does not certify the new living-inspection semantics. |
