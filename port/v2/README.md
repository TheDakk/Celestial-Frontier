...
> **Current local candidate — source-complete bounded lanes with a signed, certified Compendium
> ruler; Slice, Glass and recovery browser proof remain pending.** Gate B now recursively seals the exact 62-file domain-source inventory against DOM,
...
> uninterrupted real 20-minute certificate has not run. The Compendium ruler is active under
...
> `5677d9ed26cef8be087a87b61fca49aa0ef22d1dd273ed1993a5880079173d70`. This policy is
> Compendium-only; SceneMemory and root Gate A are unchanged.
>
...
> reporter, Glass, recovery and Compendium selftests. The current-input Compendium certificate above
> is complete; no current-input Slice/Glass run, real recovery certificate, hosted execution, HUMAN
> review, whole-Gate closure, release/version, preview/publication or deployment is claimed.
...
| Tool | Role |
|---|---|
| **Current local candidate verification (2026-08-26)** | Browser-free source gates are green: 121 Vitest files / 1,356 passed / one intentional skip / zero failures; `root/app/worker/noUnused` TypeScript; 884-module Vite build; root validate/fingerprint and legacy jsdom smoke; contract/reporter/Glass/recovery/Compendium selftests. Current-input Compendium certification is 78/78 plus named verifier on signed activation `d33e540…`. Slice, Glass, recovery, hosted, HUMAN, whole-Gate and release evidence remain open. |
| **Current Compendium authority (`active`)** | Measurement `cb5cd9f86ac99435028f98af800bc0d89de96bd7db88694214d832eed83fb15d` and producer `587d3bdfab471370e625c71d1658e391067881fe824ce14ccfaf7200eb6e4d73` bind selected c3/c5/c6 plus baseline1 and exact 14-phone/13-desktop discrimination. Signed activation is `d33e540f0d620eac34bdc259b7814db0f11a9006`; exact-budget run `20260826-phase4-certification` passed 78/78 plus its named verifier. Report raw/gzip SHA-256 are `3afe41034c78c11e1e59eeeff542e00f21a155f99bfc752afea8736a0eddffcd` / `5677d9ed26cef8be087a87b61fca49aa0ef22d1dd273ed1993a5880079173d70`. Browser authority v2 binds Microsoft Edge family + CDP `1.3` + sealed capability-contract SHA-256 `6eed33ed9784f7c7774c4b1bf8d4e880986e31667324d9a1aa7b8dd62fe5a476`; exact Edge `151.0.4129.107` and its revision/JavaScript/path/UA tuple are provenance only. Auto-update alone never rebaselines or changes a ceiling; an observed breach remains red. SceneMemory and root Gate A are unchanged. |
