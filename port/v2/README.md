...
> scheduler repair and fail-closed static-server recalibration present; exact-731 local battery green,
...
>
> **Current shutdown/recalibration boundary:** exact implementation `aecf386…` bounds the owned
...
> settle-before-force/reentrant/stale controls. Cleanup red suppresses PASS/sample. Collector,
> selftest, measurement, budget, and focused test are `0c7ec3ba…`, `0bbb3541…`, `23aacc2c…`,
> `c711c8a5…`, and `2f3f8dce…`; producer remains `d3223177…`. Candidate24/25/26+baseline10 are
> historical only. Current state is calibration-required with empty candidates/null ceilings and a
> measurement-required/null paired baseline. Planned clean serial recollection is c27, baseline11,
> c28, c29 under fresh exact Edge `.86`, one attempt/zero retry.
>
...
Highest-priority active v2 work is the fail-closed Compendium c27/baseline11/c28/c29 recalibration
after bounded static-server shutdown, without widening D-TRAIN-1's eleven-field boundary.
