...
> remains unchanged. Budget/test `41482f1c…` / `85420929…` are fail-closed
> `calibration-required`, pending paired baseline7 plus independent candidate14/15/16. The 45-second
> CI cold-start allowance is accepted process environment, not a game optimization target. After
> this one authority refresh and one battery/CI attempt, work returns to the gameplay roadmap.
...
red. Collect paired baseline7 plus independent candidate14/15/16 once under measurement `6ba58522…`,
activate valid replayed evidence, then run one complete unchanged-head battery and one corresponding
PR test-merge attempt. Do not expand timing policy or optimize the accepted 45-second CI allowance;
...
budget/test `41482f1c…` / `85420929…` fail closed pending baseline7/candidate14/15/16.
