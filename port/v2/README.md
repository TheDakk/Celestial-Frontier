...
> sample, outcome and browser-version policy remain unchanged. The next local step is one clean,
> committed, unchanged-source Compendium → Slice → Glass chain with every named verifier.
