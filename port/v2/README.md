...
> are scoped dirty-source diagnostics only. The same finished dirty source passes the complete
...
> unchanged. A clean signed candidate and one unchanged-source
...
> evidence remains immutable):** local `openai/mac` is at signed predecessor
> `05690215771db91601cf9dbcbcaa8d771fe540b5`, tree
> `00ee47169a3929dfbe952842419641a3f69699aa`, one commit ahead of `origin/openai/mac` at exact
> consumed-red head `18c088de4388edf58eda2c192b71cb94156e26e7`, based against `origin/develop`
...
>
> The dirty local successor makes all live SceneMemory native-heap work production-only while
...
> and shared browser-CDP selftest are green. A clean SSH-signed exact source,
> hermetic tracked-input preflight and one fresh unchanged-source Compendium → Slice → Glass
> chain remain before a new exact-head authorization may be requested. Production remains strict
