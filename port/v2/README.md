...
> scheduler repair, and active resource ruler present; final-head browser battery
...
> findings/retries, report SHA-256 `0d4a7f80…`. A later Smoke-instrument commit still needs its own
> final-head certification carrier.
...
> preserves rich image/worker/broker diagnostics. One fresh final-head Smoke, the remaining browser
> battery, push, PR CI, and fresh six-image HUMAN review remain open.
>
...
carry the repaired Arc 1A producer's active ruler and 788 certification through the final Smoke
instrument head, and complete a fresh six-image [HUMAN] review without
...
one fresh final-head certification/browser battery and green no-retry PR CI; da0's local PASS, its
CI red, 788's certification, and the first repaired-producer Smoke instrument red all remain preserved.
