...
> **The current local product boundary includes Arc 3 Engineering, player-facing Arc 4 capture and
...
> Retained Arc 4 browser reports below predate Arc 5A; the terminal-green final current-input Arc 5A
