...
> **Current local candidate — source-complete bounded lanes with two preserved Slice reds and a
...
> reporter, Glass, recovery and Compendium selftests. Current-input Slice retains two
...
> the selected world being card-owned; its bounded tool-only repair is local and unrerun. The fresh
...
| Tool | Role |
|---|---|
| **Current local candidate verification (2026-08-26)** | Browser-free source gates are green: 121 Vitest files / 1,358 passed / one intentional skip / zero failures; `root/app/worker/noUnused` TypeScript; 884-module Vite build; root validate/fingerprint and legacy jsdom smoke; contract/reporter/Glass/recovery/Compendium selftests. Current-input Slice retains two one-attempt/zero-retry reds on Edge `.107`: `20260826214541492-83064-b252b137f7a3` failed after 92,772 ms with two instrument false reds and one retained-Survey focus regression; changed-source `20260827000034983-98202-869d966f2f88` failed after 92,566 ms with only the newly exposed impossible card-context oracle. Settings and Survey focus are outcome-cleared; the Arc 3 tool-only repair is local and unrerun. Current Compendium certification/named verification is green. No current-input Slice PASS, Glass result or recovery certificate exists; hosted, HUMAN, whole-Gate and release evidence remain outstanding and unclaimed. |
