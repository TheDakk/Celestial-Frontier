...
> **Current local candidate — signed Final5 stopped fail-closed at Compendium; repaired Final6
> checkpoint next.** Signed clean `39e4f20fb35e47d5a05855f040ad1ae1cd921f75` supplied Layout
> `20260827-phase4-final5-39e4f20fb35e-layout` at 787/787 and source-bound SceneMemory
...
> 3,237 ms with zero retained product outcomes out of 78 expected, and was not retried. Slice, Glass
> and recovery did not start. The instrument compared eight mounted fixture keys with eight pre-arm
> cached Planetside keys even though direct evidence proved the errored row's exact visual key absent
> from that set. This is a cardinality-oracle defect, not a Compendium product verdict.
>
> The bounded repair proves exact set membership and rejects cached/wrong keys. Current Compendium
> authorities are collector `c13a489d…3faab`, outcome contract `ac7eea39…6d17`, measurement
> `28b06f3c…276c`, budget-file `3e660742…2ae5` and unchanged producer `bf9ad0b6…4dcb`; all
> numeric ceilings and historical samples remain unchanged. Browser-free verification is green at
> 135 files / 1,479 passed / one intentional skip, with TypeScript, build, evidence selftests and
> root validation/fingerprint also green. These changed evidence bytes require a newly signed clean
> Final6 checkpoint and complete fresh chain from Layout; Final5 cannot resume. Edge
> `151.0.4129.107` / CDP `1.3` is run provenance only, never a rebaseline or threshold-change
> trigger. No current Compendium product PASS, Slice, Glass, recovery, whole-Gate, hosted, HUMAN or
> release authority exists. Earlier Slice and SceneMemory reds remain diagnostic history. Gate B now recursively seals the exact
...
> ceilings. A newly signed clean source and full fresh Final6 restart at Layout are required;
> current Compendium product, Slice, Glass, recovery and whole-Gate evidence remain open.
>
...
> preview/publication and deployment authority were unclaimed. The later Final4 and Final5 history
> plus current Final6 restart boundary are recorded in the current status above.
>
...
| **Current local candidate verification (2026-08-27)** | Signed clean `39e4f20…` supplied Final5 Layout `…-layout` at 787/787 and source-bound SceneMemory `…-scenemem` at 42/42. Compendium `…-compendium` then ran once, stopped `instrument-fail` after 3,237 ms with 0/78 retained product outcomes and was not retried; Slice, Glass and recovery did not start. Exact carriers, sizes and hashes are in `audits/README.md`. The exact-membership repair is browser-free green at 135 files / 1,479 passed / one intentional skip, all TypeScript/no-unused programs, the 887-module build, authority printer, Smoke/Glass/recovery/Compendium selftests and root validation/fingerprint. SceneMemory budget is `a23a3d80…8355`; repaired Compendium collector/outcome-contract/measurement/budget-file are `c13a489d…3faab` / `ac7eea39…6d17` / `28b06f3c…276c` / `3e660742…2ae5`, with unchanged producer `bf9ad0b6…4dcb` and unchanged numeric ceilings. The worktree must become a newly signed clean checkpoint and restart Final6 at Layout; Final5 cannot resume. Edge `.107` / CDP `1.3` is provenance only. No current Compendium product PASS, Slice, Glass, recovery, hosted/HUMAN whole-Gate or release authority exists. |
| **Current Compendium evidence boundary (Final5 is an immutable instrument stop)** | Signed `041d1cf…` passed historical Final4 Compendium 78/78; its report raw/gzip SHA-256 are `e7c26d37cc653da74900ca03700b175c3020e8d07a293542a7e9d9dfa9849585` / `b8ce7e6bcbecaff7ab6f150afc32856d68422b1d90ae250c65782e917552d1ca`. Signed `39e4f20…` reached Final5 Compendium after Layout/SceneMemory greens, but run `20260827-phase4-final5-39e4f20fb35e-compendium` stopped at 0/78 because `8 > 8` could not prove a cold key even though exact set membership did. Its raw/gzip SHA-256 are `2fa2957d0fd557512ea9cbee1483ba560ac72740d8566332614ca73f406e03be` / `555fcb6682b6995df23b511f2f675886226306efe9552ddfd4965d76688c34b2`. It made no product judgment, emitted no review PNGs, was not retried and cannot seed a successor. Current collector `c13a489d…3faab`, outcome contract `ac7eea39…6d17`, measurement `28b06f3c…276c` and budget-file `3e660742…2ae5` bind unchanged producer `bf9ad0b6…4dcb`; numeric ceilings and historical samples remain fixed. Fresh Final6 from Layout is required. Browser authority remains Edge family + CDP `1.3` + capability contract; exact `.107` is provenance only. HUMAN/Glass/recovery/whole-Gate closure remains open. |
...
| `npx vitest run tests/scenemem-contract.test.ts tests/scenemem-budget.test.ts tests/scenemem-tool.test.ts tests/scenemem-workflow.test.ts` / `node tools/scenemem.mjs --budget=budgets/scene-memory-v2.json` / `node tools/scenemem.mjs --verify-run=<run-id> --budget=budgets/scene-memory-v2.json` | Negative-controls the Arc 1 scene-memory contract, tracked v2 budget, workflow binding and terminal verifier; then performs one no-retry raw-CDP certification and independently verifies the exact named report. Forty-two outcomes bind exact scene ownership/work, transient peaks, canonical Pixi inventory, heap/DOM/resource bounds, target answerability, independent heartbeat, zero pending work, bfcache survival and cleanup. Signed `39e4f20…` passed Final5 run `20260827-phase4-final5-39e4f20fb35e-scenemem` 42/42 with zero findings and complete cleanup. The later Compendium evidence repair makes the whole signed predecessor chain historical for current worktree bytes and requires Final6 from Layout; it does not change SceneMemory budget `a23a3d80…8355`, its numeric ceilings or calibration samples. Exact Edge provenance is mandatory but not baseline identity. Automation supplies neither HUMAN nor merge authority. |
| **Current SceneMemory evidence and calibration boundary (2026-08-27)** | Signed `39e4f20…` is the latest exact 42/42 report, Final5 run `20260827-phase4-final5-39e4f20fb35e-scenemem`; its raw/gzip SHA-256 are `2fb765c87ca6c85fec9d4a949abb5971e6cb4ee3bea2c44d44e7969fd23c6b33` / `d7725f545251ffd985c6ab84cb1990289c01041e6ecfe907fef74c42d94d8c97`. Signed `862a75b…` remains the paired 40/42 heap/DOM red; signed `6c9ad855…` supplied three clean calibration candidates; signed activation `4a54c0d…` set 12 MiB V8 /18 MiB aggregate with every other ceiling and paired discrimination intact. Budget `a23a3d80…8355` is unchanged. Because the current Compendium instrument repair changes repository evidence bytes, the full chain must restart at Layout under a newly signed Final6 source. A compatible Edge update remains provenance only and never triggers rebaseline, recalibration or threshold movement. |
