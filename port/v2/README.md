...
| **Current Compendium quiescent/settlement contract (2026-08-30; certification pending)** | Historical signed `20460008…` stopped truthfully at **76/78** on the obsolete full-capacity warm predicate; signed `3fb958f8…` then stopped instrument-only because its nullable witness collapsed 577 timely observations to `null`. Structured-instrument source `b2eecfbd…` ran once/no-retry on Edge `152.0.4191.53` / CDP `1.3` and stopped instrument-only after 33,041 ms: eight distinct Planetside rows were ready/decoded at 132×132, but generic observation-v1 capped each real 766–779-character canonical key at 512 and projected `visualKey:null`. It judged zero outcomes, blocked all 78 and produced no desktop or successor. Historical `326d3b…` / `7ac505…` / `ece4ed…` / `c272a1…` authorities and the 7,010-byte gzip carrier `b973b596…` remain bound to that red. Signed implementation `d9d79025794c95d5491ab9c9e1139b66eea7be5e` (tree `d4bc3a04bec6243045a6941feadd9074a7722e79`, parent `b2eecfbd9379f50c25208ca8bcd72501b07e303c`) changes no product byte and owns observation v2: full opaque keys are validated in the page realm; the carrier emits only length plus exact indices into independently produced leased/cache inventories, each capped at 256 entries before membership/Set work, with per-image membership/distinctness, inventory-length equality with live lease/cache counts and inventory-internal distinctness. Literal 256-entry controls pass, 257-entry controls fail, and 768–831-character keys pass. Current capability / measurement / contract / collector / budget are `35eb09daa39f211b8e9015f59b77a983b5870611322d673c47f7ff4f2b61e341` / `87d6782ad7d4ceaed3222eef8d2740dfe964db6d02b628fa2c3e125eaea6d06d` / `abedc70f6ffcd3130445f4a5e1681ba7a2607210fbb9e6f3522ac8a7ab752138` / `b75f426541982bc431c01f127c3410a1030ef0fd51f849e1833d492313025f4e` / `7efe9fa86075e33518020d41e7cc48bf9b2bc75ecb7ed9c0e074bd84c4d74200`; producer remains `0de7dc1a95ceeb35738d4cb17e7ccd464aab947848a9fe643e7c69355836bf13`. Exact foreground receipts and the 85-phase history contract remain. Browser-free closure is 565 selftest controls, focused 35/35, 237 files / 2,413 passed + one skipped, three green typechecks, green authority printer/budget matches and independent review CLEAR. Fresh Compendium browser certification and named verification remain required; no Slice/Glass/Recovery successor exists. |
