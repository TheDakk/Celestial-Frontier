...
> numeric budget in either ruler. Both changed final frozen producers require new bound certificates.
...
> sealed Edge-family + CDP `1.3` capability/profile authorities with unchanged numeric budgets.
> Their final frozen producers require new certificates. No current-input Slice PASS, Glass result or
