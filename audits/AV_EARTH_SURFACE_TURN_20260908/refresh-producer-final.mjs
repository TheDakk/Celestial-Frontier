...
const report=JSON.parse(fs.readFileSync('audits/AV_EARTH_SURFACE_TURN_20260908/producer-final.json','utf8'));
...
fs.writeFileSync('audits/AV_EARTH_SURFACE_TURN_20260908/producer-refresh-final.json',JSON.stringify({previous:previous.sha256,current,measurementUnchanged:true,rulerUnchanged:true,ceilingsUnchanged:true,sceneMemoryQuarantined:true},null,2)+'\n',{flag:'wx'});
