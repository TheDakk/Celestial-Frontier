...
const root=process.cwd(),audit=path.join(root,'audits/AV_EARTH_SURFACE_MATERIAL_20260908'),v2=path.join(root,'port/v2');
const steps=[
 ...
 ['final-focused','npm',['test','--','apps/game/src/planet-surface-turn-view.test.ts','tests/planet-surface-atlas.test.ts','tests/planet-surface-turn-math.test.ts','tests/current-producer-authorities.test.ts','tests/compendium-budget.test.ts','tests/guide-release.test.ts','tests/slicesmoke-guide-release-scroll-contract.test.ts','tests/slicesmoke-dtrain-release-convergence.test.ts'],v2],
...
const report={status:'RUNNING',scope:'Material proof focused verification; historical full-profile stop remains open',steps:[]};
