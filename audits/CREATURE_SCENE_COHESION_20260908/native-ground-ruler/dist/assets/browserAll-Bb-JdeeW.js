import { $t as extensions, A as init_Ticker, H as init_Container, Jt as Point, M as init_const, Qt as ExtensionType, V as Container, Xt as eventemitter3_default, Yt as init_Point, Zt as init_eventemitter3, _t as warn, dt as removeItems, en as init_Extensions, gt as init_warn, j as UPDATE_PRIORITY, k as Ticker, nn as __esmMin, ut as init_removeItems } from "./Geometry-CgCjw-Bj.js";
import { i as init_init$4, r as init_init$3 } from "./defaultFilter.vert-D5W_H1zX.js";
import { t as init_init$5 } from "./init-CiSqEodx.js";
//#region port/v2/node_modules/pixi.js/lib/dom/CanvasObserver.mjs
var CanvasObserver;
var init_CanvasObserver = __esmMin((() => {
	init_const();
	init_Ticker();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/events/FederatedEvent.mjs
var FederatedEvent;
var init_FederatedEvent = __esmMin((() => {
	init_Point();
	FederatedEvent = class FederatedEvent {
		/**
...
//#endregion
//#region port/v2/node_modules/ismobilejs/esm/isMobile.js
...
//#endregion
//#region port/v2/node_modules/ismobilejs/esm/index.js
var init_esm = __esmMin((() => {
	init_isMobile$1();
	init_isMobile$1();
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/utils/browser/isMobile.mjs
var isMobile;
var init_isMobile = __esmMin((() => {
	init_esm();
	isMobile = (isMobile$1.default ?? isMobile$1)(globalThis.navigator);
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/accessibility/AccessibilitySystem.mjs
...
var init_AccessibilitySystem = __esmMin((() => {
	init_CanvasObserver();
	init_FederatedEvent();
	init_Extensions();
	init_isMobile();
	...
	DIV_HOOK_POS_Y = -1e3;
	DIV_HOOK_ZINDEX = 2;
	_AccessibilitySystem = class _AccessibilitySystem {
		/**
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/accessibility/accessibilityTarget.mjs
var accessibilityTarget;
var init_accessibilityTarget = __esmMin((() => {
	accessibilityTarget = {
		accessible: false,
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/dom/DOMPipe.mjs
var DOMPipe;
var init_DOMPipe = __esmMin((() => {
	init_Extensions();
	init_CanvasObserver();
	DOMPipe = class {
		/**
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/events/EventTicker.mjs
var EventsTickerClass, EventsTicker;
var init_EventTicker = __esmMin((() => {
	init_const();
	init_Ticker();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/events/FederatedMouseEvent.mjs
var FederatedMouseEvent;
var init_FederatedMouseEvent = __esmMin((() => {
	init_Point();
	init_FederatedEvent();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/events/FederatedPointerEvent.mjs
var FederatedPointerEvent;
var init_FederatedPointerEvent = __esmMin((() => {
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/events/FederatedWheelEvent.mjs
var FederatedWheelEvent;
var init_FederatedWheelEvent = __esmMin((() => {
	init_FederatedMouseEvent();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/events/EventBoundary.mjs
var PROPAGATION_LIMIT, tempHitLocation, tempLocalMapping, EventBoundary;
var init_EventBoundary = __esmMin((() => {
	init_eventemitter3();
	init_Point();
	init_warn();
	init_EventTicker();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/events/EventSystem.mjs
var MOUSE_POINTER_ID, TOUCH_TO_POINTER, _EventSystem, EventSystem;
var init_EventSystem = __esmMin((() => {
	init_Extensions();
	init_EventBoundary();
	init_EventTicker();
	init_FederatedPointerEvent();
	...
	_EventSystem = class _EventSystem {
		/**
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/events/FederatedEventTarget.mjs
var FederatedContainer;
var init_FederatedEventTarget = __esmMin((() => {
	init_EventSystem();
	init_FederatedEvent();
	FederatedContainer = {
		onclick: null,
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/accessibility/init.mjs
var init_init$2 = __esmMin((() => {
	init_Extensions();
	init_Container();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/dom/init.mjs
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/events/init.mjs
