...
server.listen(port, '127.0.0.1', () => console.log(JSON.stringify({ schema: 'cf-local-earth-cohesion-server/v1', url: `http://127.0.0.1:${port}/`, pid: process.pid, output, certification: false, filesVerified: inventory.size })));
