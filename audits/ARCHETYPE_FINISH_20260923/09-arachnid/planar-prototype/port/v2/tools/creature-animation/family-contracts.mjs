...
contracts.find(t=>t.id==='arachnid').contactStance={default:'all',rootAccommodation:'planar',hind:['leg3Far','leg3Near','leg4Far','leg4Near'],actions:{cast:'hind',victory:'hind',dodge:'none'},travel:{hit:'source-steps',tame:'source-steps'}};
