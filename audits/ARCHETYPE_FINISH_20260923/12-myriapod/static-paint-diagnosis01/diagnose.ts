...
const base='/Users/nick/Projects/celestial-frontier-openai-mac/audits/ARCHETYPE_FINISH_20260923/12-myriapod',out=path.join(base,'static-paint-diagnosis01/report.json');
...
const record=read('fit-04/record.json'),binding=read('fit-04/binding.json'),original=read('static-01.json'),pre=read('fit-04/pre-regional-binding.json'),regions=read('fit-04/regional-authoring-receipt.json');
...
const findings=[];
for(const [action,expectedMs]of [['tame',48],['feed',58]]){
