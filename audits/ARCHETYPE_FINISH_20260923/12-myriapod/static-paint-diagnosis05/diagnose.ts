...
const base='/Users/nick/Projects/celestial-frontier-openai-mac/audits/ARCHETYPE_FINISH_20260923/12-myriapod',out=path.join(base,'static-paint-diagnosis05/report.json');
...
const record=read('fit-08/record.json'),binding=read('fit-08/binding.json'),original=read('static-05.json'),pre=read('fit-08/pre-regional-binding.json'),regions=read('fit-08/regional-authoring-receipt.json');
