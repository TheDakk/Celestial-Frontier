...
import {resolveFixedAttachments} from './fixed-attachments.mjs';
const contracts = [
  {
    "id": "quadruped",
    "version": 1,
...
export function familyContractForRecord(record){return projectTemplateLimits(resolveFixedAttachments(resolveAnatomyInventory(familyContract(record.template.id),record.anatomy),record),record);}
