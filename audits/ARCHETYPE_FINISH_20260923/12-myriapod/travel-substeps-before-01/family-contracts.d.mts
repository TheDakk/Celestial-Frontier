...
export interface FamilyContract extends SkeletonDefinition {
 ...
 readonly contactStance?:{readonly default:'all'|'hind'|'none';readonly swingLift?:'toward-socket';readonly hind?:readonly string[];readonly gaits?:Readonly<Record<string,'alternating'|'bounding'>>;readonly travel?:Readonly<Record<string,'source-steps'>>;readonly actions:Readonly<Record<string,'all'|'hind'|'none'>>};
