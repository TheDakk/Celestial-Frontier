...
const base='/Users/nick/Projects/celestial-frontier-openai-mac/audits/ARCHETYPE_FINISH_20260923/12-myriapod',out=path.join(base,'static-paint-diagnosis02/report.json');
...
const record=read('fit-05/record.json'),binding=read('fit-05/binding.json'),original=read('static-02.json'),pre=read('fit-05/pre-regional-binding.json'),regions=read('fit-05/regional-authoring-receipt.json');
...
const findings=[];
for(const [action,expectedMs]of [['hit',22.5],['dodge',21],['tame',53.333333333333336]]){
