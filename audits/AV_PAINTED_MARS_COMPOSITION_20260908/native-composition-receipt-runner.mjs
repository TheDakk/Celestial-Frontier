...
// node audits/AV_PAINTED_MARS_COMPOSITION_20260908/native-composition-receipt-runner.mjs DIST FRESH_OUTPUT phone|desktop|blocked|default
...
try {
  ...
  const landReceipt = (before,after) => {
    ...
    assert.equal(d.drawsConsumed,2);assert.equal(ar.ordinal,br.ordinal+1);
