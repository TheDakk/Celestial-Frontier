...
const report=JSON.parse(fs.readFileSync('audits/AV_EARTH_LAYERED_SCENE_20260908/producer.json','utf8'));
...
assert.equal(previous.sha256,'705a12f14157c7501ccf420ad446aeccf881a5f22929c6e7c145e2926e83d9cf');
...
fs.writeFileSync('audits/AV_EARTH_LAYERED_SCENE_20260908/producer-refresh.json',JSON.stringify({previous:previous.sha256,current,measurementUnchanged:true,rulerUnchanged:true,ceilingsUnchanged:true,sceneMemoryQuarantined:true},null,2)+'\n',{flag:'wx'});
