...
const report=JSON.parse(fs.readFileSync('audits/AV_EARTH_LAYERED_SCENE_20260908/producer-corrected.json','utf8'));
...
assert.equal(previous.sha256,'ee9ddca2dc3b5c224e744ebf9e612343564f9836190c8f2b6ffd2c831b144c50');
...
fs.writeFileSync('audits/AV_EARTH_LAYERED_SCENE_20260908/producer-refresh-corrected.json',JSON.stringify({previous:previous.sha256,current,measurementUnchanged:true,rulerUnchanged:true,ceilingsUnchanged:true,sceneMemoryQuarantined:true},null,2)+'\n',{flag:'wx'});
