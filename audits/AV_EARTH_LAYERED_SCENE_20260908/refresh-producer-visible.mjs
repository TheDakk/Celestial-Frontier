...
const report=JSON.parse(fs.readFileSync('audits/AV_EARTH_LAYERED_SCENE_20260908/producer-visible.json','utf8'));
...
assert.equal(previous.sha256,'d36a683db2e5ed38c7e2348e8026fe07fc5ff6b9d41d0b9db54346a329090725');
...
fs.writeFileSync('audits/AV_EARTH_LAYERED_SCENE_20260908/producer-refresh-visible.json',JSON.stringify({previous:previous.sha256,current,measurementUnchanged:true,rulerUnchanged:true,ceilingsUnchanged:true,sceneMemoryQuarantined:true},null,2)+'\n',{flag:'wx'});
