...
// node audits/AV_EARTH_LAYERED_SCENE_20260908/native-earth-layers-source-runner.mjs DIST FRESH_OUTPUT phone|desktop|blocked|default
...
try {
  ...
  const landReceipt = (before,after) => {
    ...
    assert.equal(d.policy.key,address);assert.equal(d.policy.planetType,'terran');assert.equal(d.policy.biomeKey,'temperate');
