/** Candidate11 refines only the diagnosed tail-fold area plus its collar. Global40/80 and local24/56; authored rectangle in authoring.json. No runtime, solver, masks, pixels or gate changes. */
