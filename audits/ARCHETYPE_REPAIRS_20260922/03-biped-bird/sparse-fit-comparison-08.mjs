...
const base=import.meta.dirname,root=path.resolve(base,'../../..'),out=path.join(base,'sparse-fit-comparison-08.json');
...
const oldRecord=json('fit-05/record.json'),oldBinding=json('fit-05/binding.json'),record=json('fit-08/record.json'),binding=json('fit-08/binding.json');
