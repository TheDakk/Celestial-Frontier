...
for(const kind of ['guardian','titan']){
 ...
 const e=api.projectGuardianPrimeEncounterV1({world:w.address,descriptor:{worldType:kind==='guardian'?'airless':'rocky'},regionIndex:0,faunaRoster:[],claimedSignatureIds:[],conquered:false});
