import { $t as extensions, B as init_ViewContainer, Bt as init_uid, Ct as init_Texture, F as DOMAdapter, Gt as init_groupD8, Ht as Rectangle, I as init_adapter, It as deprecation, J as init_InstructionSet, Jt as Point, Kt as Matrix, Lt as init_deprecation, Mt as definedProps, N as CanvasSource, Nt as init_definedProps, P as init_CanvasSource, Q as init_getGlobalMixin, Qt as ExtensionType, Rt as v8_0_0, St as Texture, Ut as init_Rectangle, Vt as uid, Wt as groupD8, Xt as eventemitter3_default, Yt as init_Point, Z as bgr2rgb, Zt as init_eventemitter3, _t as warn, bt as Bounds, en as init_Extensions, ft as BigPool, gt as init_warn, l as State, m as init_types, nn as __esmMin, nt as multiplyHexColors, p as RendererType, pt as init_PoolGroup, q as InstructionSet, qt as init_Matrix, rn as __exportAll, tt as init_multiplyHexColors, u as init_State, vt as Color, xt as init_Bounds, yt as init_Color, z as ViewContainer, zt as v8_3_4 } from "./Geometry-CgCjw-Bj.js";
import { a as ImageSource, i as init_canUseNewCanvasBlendModes, n as init_canvasUtils, o as init_ImageSource, r as canUseNewCanvasBlendModes, t as canvasUtils } from "./canvasUtils-D4O_SOPi.js";
import { C as init_DefaultBatcher, J as AbstractRenderer, S as DefaultBatcher, Y as init_AbstractRenderer, _ as init_BatcherPipe, a as init_SharedSystems, b as GCManagedHash, c as SpritePipe, d as init_RenderGroupPipe, f as CustomRenderPipe, g as BatcherPipe, h as init_AlphaMaskPipe, i as SharedSystems, l as init_SpritePipe, m as AlphaMaskPipe, n as init_RenderTargetSystem, o as BlendModePipe, p as init_CustomRenderPipe, s as init_BlendModePipe, t as RenderTargetSystem, u as RenderGroupPipe, v as color32BitToUniform, x as init_GCManagedHash, y as init_colorToUniform } from "./RenderTargetSystem-C8zObf9q.js";
import { n as init_getTextureBatchBindGroup, t as getTextureBatchBindGroup } from "./getTextureBatchBindGroup-BqyP7eOb.js";
//#region port/v2/node_modules/earcut/src/earcut.js
/**
...
var steiners, filteredOut, indexActive, K, blockBBox, numBlocks, blockHead, blockStop, sortArr, sortBuf, zArr, zBuf, counts;
var init_earcut = __esmMin((() => {
	steiners = /* @__PURE__ */ new Set();
	filteredOut = false;
	indexActive = false;
	K = 16;
	blockBBox = /* @__PURE__ */ new Float64Array(0);
	numBlocks = 0;
	blockHead = [];
	blockStop = [];
	sortArr = [];
	sortBuf = [];
	zArr = /* @__PURE__ */ new Uint32Array(0);
	zBuf = /* @__PURE__ */ new Uint32Array(0);
	counts = /* @__PURE__ */ new Uint32Array(256);
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/utils/utils.mjs
var earcut;
var init_utils = __esmMin((() => {
	init_earcut();
	init_eventemitter3();
	earcut = earcut$1.default || earcut$1;
}));
//#endregion
//#region port/v2/node_modules/parse-svg-path/dist/index.mjs
/**
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/svg/parseSVGPath.mjs
...
var init_parseSVGPath = __esmMin((() => {
	init_dist();
	init_warn();
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/maths/shapes/Circle.mjs
var Circle;
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/maths/shapes/Ellipse.mjs
var Ellipse;
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/maths/misc/squaredDistanceToLineSegment.mjs
...
var init_squaredDistanceToLineSegment = __esmMin((() => {}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/maths/shapes/Polygon.mjs
var tempRect$2, tempRect2, Polygon;
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/maths/shapes/RoundedRectangle.mjs
var isCornerWithinStroke, RoundedRectangle;
var init_RoundedRectangle = __esmMin((() => {
	init_Rectangle();
	...
	RoundedRectangle = class RoundedRectangle {
		/**
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/rendering/renderers/shared/geometry/utils/buildUvs.mjs
...
var init_buildUvs = __esmMin((() => {}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/rendering/renderers/shared/geometry/utils/transformVertices.mjs
...
var init_transformVertices = __esmMin((() => {}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/BatchableGraphics.mjs
var identityMatrix, BatchableGraphics;
var init_BatchableGraphics = __esmMin((() => {
	init_Matrix();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildCircle.mjs
var buildCircle, buildEllipse, buildRoundedRectangle;
var init_buildCircle = __esmMin((() => {
	init_Extensions();
	buildCircle = {
		extension: {
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/const.mjs
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/utils/getOrientationOfPoints.mjs
...
var init_getOrientationOfPoints = __esmMin((() => {}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildLine.mjs
...
var init_buildLine = __esmMin((() => {
	init_Point();
	init_const();
	init_getOrientationOfPoints();
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildPixelLine.mjs
...
var init_buildPixelLine = __esmMin((() => {
	init_const();
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/utils/triangulateWithHoles.mjs
...
var init_triangulateWithHoles = __esmMin((() => {
	init_utils();
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildPolygon.mjs
var emptyArray, buildPolygon;
var init_buildPolygon = __esmMin((() => {
	init_Extensions();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildRectangle.mjs
var buildRectangle;
var init_buildRectangle = __esmMin((() => {
	init_Extensions();
	buildRectangle = {
		extension: {
			type: ExtensionType.ShapeBuilder,
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildTriangle.mjs
var buildTriangle;
var init_buildTriangle = __esmMin((() => {
	init_Extensions();
	buildTriangle = {
		extension: {
			type: ExtensionType.ShapeBuilder,
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/fill/FillGradient.mjs
...
var init_FillGradient = __esmMin((() => {
	init_Color();
	init_adapter();
	init_Matrix();
	init_ImageSource();
	...
	_FillGradient = class _FillGradient {
		constructor(...args) {
			/**
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/utils/generateTextureFillMatrix.mjs
function generateTextureMatrix(out, style, shape, matrix) {
	...
	if (matrix) textureMatrix.append(tempTextureMatrix$2.copyFrom(matrix).invert());
	return textureMatrix;
}
var tempTextureMatrix$2, tempRect$1;
var init_generateTextureFillMatrix = __esmMin((() => {
	init_Matrix();
	init_Rectangle();
	init_FillGradient();
	tempTextureMatrix$2 = new Matrix();
	tempRect$1 = new Rectangle();
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/utils/buildContextBatches.mjs
...
var shapeBuilders, tempRect, tempTextureMatrix$1;
var init_buildContextBatches = __esmMin((() => {
	init_Extensions();
	init_Matrix();
	init_Rectangle();
	init_buildUvs();
	...
	tempTextureMatrix$1 = new Matrix();
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/GraphicsContextSystem.mjs
var GpuGraphicsContext, GraphicsContextRenderData, _GraphicsContextSystem, GraphicsContextSystem;
var init_GraphicsContextSystem = __esmMin((() => {
	init_Extensions();
	...
	_GraphicsContextSystem = class _GraphicsContextSystem {
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildAdaptiveBezier.mjs
...
var RECURSION_LIMIT$1, FLT_EPSILON$1, PATH_DISTANCE_EPSILON$1;
var init_buildAdaptiveBezier = __esmMin((() => {
	init_GraphicsContextSystem();
	RECURSION_LIMIT$1 = 8;
	FLT_EPSILON$1 = 1.1920929e-7;
	PATH_DISTANCE_EPSILON$1 = 1;
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildAdaptiveQuadratic.mjs
...
var RECURSION_LIMIT, FLT_EPSILON, PATH_DISTANCE_EPSILON;
var init_buildAdaptiveQuadratic = __esmMin((() => {
	init_GraphicsContextSystem();
	RECURSION_LIMIT = 8;
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildArc.mjs
...
var init_buildArc = __esmMin((() => {}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildArcTo.mjs
...
var init_buildArcTo = __esmMin((() => {
	init_buildArc();
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildArcToSvg.mjs
...
var init_buildArcToSvg = __esmMin((() => {
	...
	mapToEllipse = ({ x, y }, rx, ry, cosPhi, sinPhi, centerX, centerY, out2) => {
		x *= rx;
		y *= ry;
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/path/roundShape.mjs
...
var init_roundShape = __esmMin((() => {}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/path/ShapePath.mjs
var tempRectangle, ShapePath;
var init_ShapePath = __esmMin((() => {
	init_Circle();
	init_Ellipse();
	init_Polygon();
	init_Rectangle();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/path/GraphicsPath.mjs
function adjustTransform(currentMatrix, transform) {
	if (currentMatrix) return currentMatrix.prepend(transform);
	return transform.clone();
}
var GraphicsPath;
var init_GraphicsPath = __esmMin((() => {
	init_Point();
	init_uid();
	init_warn();
	init_parseSVGPath();
	init_ShapePath();
	GraphicsPath = class GraphicsPath {
		/**
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/svg/parseSVGFloatAttribute.mjs
function parseSVGFloatAttribute(svg, id, defaultValue) {
	const value = svg.getAttribute(id);
	return value ? Number(value) : defaultValue;
}
var init_parseSVGFloatAttribute = __esmMin((() => {}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/svg/parseSVGDefinitions.mjs
...
var init_parseSVGDefinitions = __esmMin((() => {
	init_Color();
	init_warn();
	init_FillGradient();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/svg/utils/extractSvgUrlId.mjs
function extractSvgUrlId(url) {
	const match = url.match(/url\s*\(\s*['"]?\s*#([^'"\s)]+)\s*['"]?\s*\)/i);
	return match ? match[1] : "";
}
var init_extractSvgUrlId = __esmMin((() => {}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/svg/parseSVGStyle.mjs
...
var styleAttributes;
var init_parseSVGStyle = __esmMin((() => {
	init_Color();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/svg/utils/fillOperations.mjs
...
var init_fillOperations = __esmMin((() => {}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/svg/utils/pathOperations.mjs
...
var init_pathOperations = __esmMin((() => {
	init_GraphicsPath();
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/svg/SVGParser.mjs
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/fill/FillPattern.mjs
function isFillPatternOptions(value) {
	return value.texture !== void 0;
}
var repetitionMap, FillPattern;
var init_FillPattern = __esmMin((() => {
	init_Matrix();
	init_uid();
	repetitionMap = {
		repeat: {
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/utils/convertFillInputToFillStyle.mjs
...
var init_convertFillInputToFillStyle = __esmMin((() => {
	init_Color();
	init_Texture();
	init_FillGradient();
	init_FillPattern();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/utils/getMaxMiterRatio.mjs
...
var init_getMaxMiterRatio = __esmMin((() => {}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/GraphicsContext.mjs
var tmpPoint, tempMatrix$2, _GraphicsContext, GraphicsContext;
var init_GraphicsContext = __esmMin((() => {
	init_eventemitter3();
	init_Color();
	init_Matrix();
	init_Point();
	...
	_GraphicsContext = class _GraphicsContext extends eventemitter3_default {
		constructor() {
			super(...arguments);
			/** @internal */
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/canvas/CanvasGraphicsContextSystem.mjs
var CanvasGraphicsContext, CanvasGraphicsContextRenderData, _CanvasGraphicsContextSystem, CanvasGraphicsContextSystem;
var init_CanvasGraphicsContextSystem = __esmMin((() => {
	init_Extensions();
	init_InstructionSet();
	init_GCManagedHash();
	CanvasGraphicsContext = class {
		constructor() {
			/**
	...
	CanvasGraphicsContextRenderData = class {
		constructor() {
			/**
	...
	_CanvasGraphicsContextSystem = class _CanvasGraphicsContextSystem {
		constructor(renderer) {
			this._renderer = renderer;
			this._managedContexts = new GCManagedHash({
				renderer,
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/canvas/CanvasGraphicsPipe.mjs
var CanvasGraphicsPipe;
var init_CanvasGraphicsPipe = __esmMin((() => {
	init_Extensions();
	init_State();
	init_GCManagedHash();
	CanvasGraphicsPipe = class {
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/GraphicsPipe.mjs
var GraphicsGpuData, GraphicsPipe;
var init_GraphicsPipe = __esmMin((() => {
	init_Extensions();
	init_State();
	init_GCManagedHash();
	init_PoolGroup();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/init.mjs
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/shared/Graphics.mjs
var Graphics;
var init_Graphics = __esmMin((() => {
	init_deprecation();
	init_ViewContainer();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/rendering/batcher/canvas/CanvasBatchAdaptor.mjs
var _CanvasBatchAdaptor, CanvasBatchAdaptor;
var init_CanvasBatchAdaptor = __esmMin((() => {
	init_Extensions();
	init_groupD8();
	init_Matrix();
	init_getGlobalMixin();
	init_multiplyHexColors();
	init_canvasUtils();
	_CanvasBatchAdaptor = class _CanvasBatchAdaptor {
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/rendering/mask/color/CanvasColorMaskPipe.mjs
var CanvasColorMaskPipe;
var init_CanvasColorMaskPipe = __esmMin((() => {
	init_Extensions();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/rendering/mask/stencil/CanvasStencilMaskPipe.mjs
...
var init_CanvasStencilMaskPipe = __esmMin((() => {
	init_Extensions();
	init_buildLine();
	init_Graphics();
	init_buildContextBatches();
	init_warn();
	CanvasStencilMaskPipe = class {
		constructor(renderer) {
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/rendering/renderers/canvas/utils/mapCanvasBlendModesToPixi.mjs
...
var FALLBACK_BLEND;
var init_mapCanvasBlendModesToPixi = __esmMin((() => {
	init_canUseNewCanvasBlendModes();
	FALLBACK_BLEND = "source-over";
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/rendering/renderers/canvas/CanvasContextSystem.mjs
var tempMatrix$1, CanvasContextSystem;
var init_CanvasContextSystem = __esmMin((() => {
	init_Color();
	init_Extensions();
	init_Matrix();
	init_mapCanvasBlendModesToPixi();
	tempMatrix$1 = new Matrix();
	CanvasContextSystem = class {
		/**
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/rendering/renderers/canvas/CanvasLimitsSystem.mjs
var CanvasLimitsSystem;
var init_CanvasLimitsSystem = __esmMin((() => {
	init_Extensions();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/graphics/canvas/CanvasGraphicsAdaptor.mjs
...
var emptyCanvasStyle, tempMatrix, tempTextureMatrix, tempGradientMatrix, tempPatternMatrix, CanvasGraphicsAdaptor;
var init_CanvasGraphicsAdaptor = __esmMin((() => {
	init_Extensions();
	init_groupD8();
	init_Matrix();
	init_canvasUtils();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/rendering/renderers/canvas/renderTarget/CanvasRenderTargetAdaptor.mjs
var CanvasRenderTargetAdaptor;
var init_CanvasRenderTargetAdaptor = __esmMin((() => {
	init_Color();
	init_adapter();
	init_CanvasSource();
	CanvasRenderTargetAdaptor = class {
		/**
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/rendering/renderers/canvas/renderTarget/CanvasRenderTargetSystem.mjs
var CanvasRenderTargetSystem;
var init_CanvasRenderTargetSystem = __esmMin((() => {
	init_Extensions();
	init_RenderTargetSystem();
	init_CanvasRenderTargetAdaptor();
	CanvasRenderTargetSystem = class extends RenderTargetSystem {
		constructor(renderer) {
			super(renderer);
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/rendering/renderers/canvas/texture/CanvasTextureSystem.mjs
var CanvasTextureSystem;
var init_CanvasTextureSystem = __esmMin((() => {
	init_adapter();
	init_Extensions();
	init_canvasUtils();
	CanvasTextureSystem = class {
		/**
		* @param renderer - The owning CanvasRenderer.
		*/
		constructor(renderer) {}
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/rendering/renderers/canvas/CanvasRenderer.mjs
var CanvasRenderer_exports = /* @__PURE__ */ __exportAll({ CanvasRenderer: () => CanvasRenderer });
var DefaultCanvasSystems, DefaultCanvasPipes, DefaultCanvasAdapters, systems, renderPipes, renderPipeAdaptors, CanvasRenderer;
var init_CanvasRenderer = __esmMin((() => {
	init_Extensions();
	...
	DefaultCanvasAdapters = [CanvasBatchAdaptor, CanvasGraphicsAdaptor];
	systems = [];
	renderPipes = [];
	renderPipeAdaptors = [];
	...
	CanvasRenderer = class extends AbstractRenderer {
		constructor() {
			const systemConfig = {
				name: "canvas",
...
//#endregion
export { init_Graphics as i, init_CanvasRenderer as n, Graphics as r, CanvasRenderer_exports as t };
