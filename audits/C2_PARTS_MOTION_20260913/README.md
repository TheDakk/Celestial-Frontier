...
Browser bundle check initially refused the CONTRACTS shorthand `parseAnchors`: the actual
export is `parseEffectSequenceAnchors`, returning `{ok, anchors}` or a refusal. The proof now
