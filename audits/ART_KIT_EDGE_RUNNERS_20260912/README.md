...
interior erosion8px instead4; Cranberry uses two low runner instances from its same
master (widths9%/8%, vertical scale50%, one mirrored). Compiler-owned profile lives in
earth-resident-plan. Normal game keeps the accepted baseline. Kit, frozen paragraph and4E
unchanged. First static composite visually inspected; native must match its pixels.

8 contact/worker controls pass, including negative controls for4px erosion, one runner,
wrong recipe admission, and disabled session cache. Initial mask fixture occupied the
