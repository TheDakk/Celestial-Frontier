...
prior=[]
for name in ['earth-material','earth-turn','painted-direction','charm-study']:
...
p=r/'port/v2/apps/game/smoke/painted-mars-staged-20260908.patch.gz';jpath=p.with_name('painted-mars-staged-20260908.json')
...
'paintedMarsManifestSha256':sha((a/'manifest.json').read_bytes()),'manifestCarriersVerified':verified,
