import { $t as extensions, C as GlProgram, Ct as init_Texture, G as TexturePool, K as init_TexturePool, Kt as Matrix, Qt as ExtensionType, St as Texture, _ as UniformGroup, _t as warn, b as init_GpuProgram, bt as Bounds, c as init_Filter, en as init_Extensions, g as init_BindGroup, gt as init_warn, h as BindGroup, m as init_types, n as init_Geometry, nn as __esmMin, p as RendererType, qt as init_Matrix, s as Filter, t as Geometry, v as init_UniformGroup, w as init_GlProgram, xt as init_Bounds, y as GpuProgram } from "./Geometry-CgCjw-Bj.js";
import { n as init_canvasUtils, t as canvasUtils } from "./canvasUtils-D4O_SOPi.js";
import { n as init_CanvasPool, t as CanvasPool } from "./CanvasPool-D0IGP4PS.js";
//#region port/v2/node_modules/pixi.js/lib/scene/container/bounds/getRenderableBounds.mjs
...
var init_getRenderableBounds = __esmMin((() => {
	init_Matrix();
	tempProjectionMatrix = new Matrix();
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/scene/text/utils/getPo2TextureFromSource.mjs
...
var tempBounds;
var init_getPo2TextureFromSource = __esmMin((() => {
	init_TexturePool();
	init_Bounds();
	tempBounds = new Bounds();
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/filters/CanvasFilterSystem.mjs
...
var init_CanvasFilterSystem = __esmMin((() => {
	init_Extensions();
	init_canvasUtils();
	init_CanvasPool();
	init_Bounds();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/filters/defaults/defaultFilter.vert.mjs
var vertex;
var init_defaultFilter_vert = __esmMin((() => {
	vertex = "in vec2 aPosition;\nout vec2 vTextureCoord;\n\nuniform vec4 uInputSize;\nuniform vec4 uOutputFrame;\nuniform vec4 uOutputTexture;\n\nvec4 filterVertexPosition( void )\n{\n    vec2 position = aPosition * uOutputFrame.zw + uOutputFrame.xy;\n    \n    position.x = position.x * (2.0 / uOutputTexture.x) - 1.0;\n    position.y = position.y * (2.0*uOutputTexture.z / uOutputTexture.y) - uOutputTexture.z;\n\n    return vec4(position, 0.0, 1.0);\n}\n\nvec2 filterTextureCoord( void )\n{\n    return aPosition * (uOutputFrame.zw * uInputSize.zw);\n}\n\nvoid main(void)\n{\n    gl_Position = filterVertexPosition();\n    vTextureCoord = filterTextureCoord();\n}\n";
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/filters/defaults/passthrough/passthrough.frag.mjs
var fragment;
var init_passthrough_frag = __esmMin((() => {
	fragment = "in vec2 vTextureCoord;\nout vec4 finalColor;\nuniform sampler2D uTexture;\nvoid main() {\n    finalColor = texture(uTexture, vTextureCoord);\n}\n";
}));
//#endregion
//#region port/v2/node_modules/pixi.js/lib/filters/defaults/passthrough/passthrough.wgsl.mjs
var source;
var init_passthrough_wgsl = __esmMin((() => {
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/filters/defaults/passthrough/PassthroughFilter.mjs
var PassthroughFilter;
var init_PassthroughFilter = __esmMin((() => {
	init_GlProgram();
	init_GpuProgram();
	init_Filter();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/filters/FilterPipe.mjs
var FilterPipe;
var init_FilterPipe = __esmMin((() => {
	init_Extensions();
	FilterPipe = class {
		constructor(renderer) {
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/filters/FilterSystem.mjs
var quadGeometry, FilterData, FilterSystem;
var init_FilterSystem = __esmMin((() => {
	init_Extensions();
...
//#endregion
//#region port/v2/node_modules/pixi.js/lib/filters/init.mjs
