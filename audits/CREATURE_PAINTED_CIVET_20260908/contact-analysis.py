...
def main():
    ...
    for size in (440, 300, 132):
        ...
        encoded_matches_raw = per_band[0]["changedPixelsWholeBand"] == original["contact"]
        rows.append({"size": size, "restImage": info, "motionImage": motion_info,
                     ...
                     "originalAlphaCountsReproducedExactly": True, "encodedPNGMatchesRawChannelDeltaCount": encoded_matches_raw, "originalRawPixelContact": original["contact"], "bands": per_band})
