	...
	sections: Object.freeze([
		Object.freeze({
			...
			bullets: Object.freeze([
				...
				"💞 BOND: Six levels, Wary to Soulbound, record distinct shared firsts and never decay. Bond itself adds no combat power; mission perks await the mission system.",
