...
import fs from 'fs';
const src = fs.readFileSync('/root/cf/v8/game.html', 'utf8');
...
const CONST = ['SP_COLOR','FA_BODY','FA_LOCO','FA_TRAIT','FA_SIZE','FA_SIZE_M','FA_DIET','FA_HEAD','FA_LIMBS',
               ...
               'FA_SENSE','FA_REPRO','FA_LIFE','FA_METAB','_VOICE','_VOICE_KEYS'];
...
export default M;
if (process.argv[1].endsWith('model8.mjs')) console.log('ok:', Object.keys(M).length, 'symbols');
