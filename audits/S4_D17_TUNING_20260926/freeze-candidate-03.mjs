...
const tuning={press:{dealt:1.4,taken:1.7},guard:{dealt:.65,taken:.585,openerBlunt:.25},evade:{dealt:.64,dodge:.32}},phase={atFraction:.5,dealt:1.02,taken:.9};globalThis.__s4=tuning;globalThis.__s4phase=phase;
