...
import {assertRestCoverage} from '../../../port/v2/tools/creature-animation/part-masks.mjs';
...
const ROOT=process.cwd(); // re-rooted (G1): the worktree root, passed as cwd by static-runner.mjs
...
if(!fit.startsWith(ROOT+'/audits/')||!out.startsWith(ROOT+'/audits/'))throw Error('audit paths inside this worktree required');
