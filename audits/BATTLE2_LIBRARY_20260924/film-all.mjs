...
const pairs = [['python-vs-tarantula', 'python', 'tarantula'], ['eagle-vs-beetle', 'eagle', 'beetle'], ['chimpanzee-vs-centipede', 'chimpanzee', 'centipede'], ['treefrog-vs-fruitbat', 'tree-frog', 'fruit-bat'], ['salmon-vs-octopus', 'salmon', 'octopus'], ['eagle-vs-salmon', 'eagle', 'salmon'], ['crab-vs-starfish', 'crab', 'starfish']];
