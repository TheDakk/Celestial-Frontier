...
const sourceNames=[
  ...
  'port/v2/apps/game/src/landfall-viewer.ts',
...
try{
  ...
  await until('painting mounted','window.__CF_SLICE__.api.state().localAi.mounted===true');
  ...
  need(await evaluate(`document.activeElement?.matches('#notificationpanel [data-ai-act="inspect"]')`),'Close did not restore its live opener');
