...
import { createLandfallViewerV1, type LandfallViewerV1 } from './landfall-viewer.js';
...
export async function createLocalAiGameV1(options: LocalAiGameOptionsV1): Promise<LocalAiGameV1> {
  ...
  let viewer: LandfallViewerV1 | null = null;
