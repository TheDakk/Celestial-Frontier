...
const rows=[];
for(const [name,fit] of [['gull','audits/ART_BATTLE_FOCUS_20260925/12-gull/fit-03'],['goose','audits/ART_BATTLE_FOCUS_20260925/15-goose/fit-02'],['heron','audits/ART_BATTLE_FOCUS_20260925/16-heron/fit-01'],['sparrow','audits/ART_BATTLE_FOCUS_20260925/17-sparrow/fit-01'],['eagle','audits/ARCHETYPE_SPRINT_20260922/03-biped-bird/fit-01']]){
 ...
 for(const id of ['dodge','hit','tame']){
