...
d.text((25,20),'SALAMANDER — item26 / Earth painting rank25 / plain master + six own masks',font=f,fill='white');d.text((25,65),'17/19 static; gallop/cast blocked. Native0/0; p95 4.10 / max9.80ms at4x.',font=sm,fill='#c5e3dc')
