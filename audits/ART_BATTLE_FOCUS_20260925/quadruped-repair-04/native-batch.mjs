...
for(const [name,fit] of [['impala','06-impala/fit-01'],['marmot','07-marmot/fit-01'],['cattle','09-cattle/fit-04']]){
 const out=path.join(p,'native-'+name+'-01'),log=out+'.log';if(fs.existsSync(out)||fs.existsSync(log))throw Error('New output required');
