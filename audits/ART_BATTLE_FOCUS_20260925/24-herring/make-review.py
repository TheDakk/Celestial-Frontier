...
d.text((25,20),'HERRING — item24 / Earth painting rank23 / plain master + six own masks',font=f,fill='white');d.text((25,65),'13/13 static +949 presentation + exact rest. Native0/0; p95 3.00 / max8.60ms at4x.',font=sm,fill='#c5e3dc')
...
for i,(file,title) in enumerate([('turn1-hit-return-end.png','Return — opposing heads overlap'),('turn3-hit-idle-90.png','Final faint — tail crosses water surface')]):
