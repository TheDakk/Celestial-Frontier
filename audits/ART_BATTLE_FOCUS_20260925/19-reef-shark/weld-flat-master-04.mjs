...
const d=import.meta.dirname,root=path.resolve(d,'../../..'),old=path.join(d,'fit-03'),out=path.join(d,'fit-04'),req=createRequire(root+'/port/v2/package.json'),sharp=createRequire(req.resolve('free-tex-packer-core'))('sharp');
