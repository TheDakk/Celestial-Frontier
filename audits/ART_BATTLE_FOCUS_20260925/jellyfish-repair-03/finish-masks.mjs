...
const fit=path.resolve(base,'fit-05'),sourcePrompt=path.resolve(base,'prompt-correction-04.txt');
...
const keyedFile=path.join(fit,'parts/keyed.png'),atlasFile=path.join(fit,'parts/atlas/jellyfish.png');
