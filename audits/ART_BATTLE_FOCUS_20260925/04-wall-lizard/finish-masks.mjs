...
const fit=path.resolve(base,'fit-06'),sourcePrompt=path.resolve(base,'prompt.txt');
...
const keyedFile=path.join(fit,'parts/keyed.png'),atlasFile=path.join(fit,'parts/atlas/wall-lizard.png');
