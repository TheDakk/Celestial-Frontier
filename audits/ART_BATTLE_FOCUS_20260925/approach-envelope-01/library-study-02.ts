...
const {archetypes:CARD_ARCHETYPES}=JSON.parse(fs.readFileSync('/Users/nick/Projects/celestial-frontier-openai-mac/audits/ART_BATTLE_FOCUS_20260925/approach-envelope-01/library-inventory.json','utf8'));
