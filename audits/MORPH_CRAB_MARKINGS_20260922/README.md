...
The loader work follows in a separate signed producer and [packet](../BORROWED_ATLAS_20260922/README.md), including the one ordered S2 sweep. Codex completes that item then holds. Claude consumes these master-space masks through the existing atlas mapping for M3/M4. Nick reviews the sheet. No fetch/sync/push/PR/merge/release/deploy.
